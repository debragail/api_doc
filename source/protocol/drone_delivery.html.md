...
A selection of one bid that wins over the rest. Sent by the requseter (a user that is looking to deliver a package using a drone).
...
<table class="arguments">
  ...
  <tr>
    <td>
      <code class="field">supported_contracts</code>
      <div class="type required">required</div>
    </td>
    <td>A comma separated list of contracts supported by the requester.</td>
  </tr>
</table>

# Contract

A contract string/url. Sent by the winning bidder (the delivery drone), confirming the mission.
...
<table class="arguments">
  ...
  <tr>
    <td>
      <code class="field">contract_address</code>
      <div class="type required">required</div>
    </td>
    <td>The url of the bidder's contract address. The supported contract is <a href="https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md" target="blank">ERC-20 Token Standard</a></td>
  </tr>
</table>

# Status

A request for a status check, sent by the requseter.
