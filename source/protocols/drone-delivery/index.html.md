...
<table class="arguments">
  <tr>
    ...
    <td>
      The time at which the service requester would like the cargo to be picked up (if undefined, the pick up time will be ASAP). This should be Specified as time in seconds since <a href="https://en.wikipedia.org/wiki/Unix_time" target="blank">Epoch/Unix Time</a>
    </td>
  </tr>
  <tr>
    <td>
...
<table class="arguments">
  ...
  <tr>
    ...
    <td>The estimate time of arrival at the pickup location. Specified as time in seconds since <a href="https://en.wikipedia.org/wiki/Unix_time" target="blank">Epoch/Unix Time</a></td>
  </tr>
  <tr>
    <td>
    ...
    <td>The estimate time of arrival at the dropoff location. Specified as time in seconds since <a href="https://en.wikipedia.org/wiki/Unix_time" target="blank">Epoch/Unix Time</a></td>
  </tr>
  <tr>
    <td>
